        ...
        <>
            {showPopup && (
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center">
                    <div className=" my-8 bg-white p-3 rounded-lg max-w-md max-h-screen ">
                        <div className="overflow-y-scroll p-2"
                                ...
                                <div className="  py-2">
                                    ...
                                    {sizes.map(size => (
                                        <label className="flex items-center gap-3 p-4 border rounded-md mb-1">
                                            <input 
                                            onChange={() => setSelectedSize(sizes)}
                                            checked={selectedSize?.name === sizes.name}
                                            type="radio" 
                            ...
                            <button className="primary" type="button">Add to chart selected price</button>
